...
class CartBloc extends Bloc<CartEvent, CartState> {
  ...
  Stream<CartState> mapEventToState(CartEvent event,) async* {
    ...
    } else if (event is CartProductAdd) {
  ...
  Stream<CartState> _mapCartProductAddedToState (CartProductAdd event, CartState state) async* {
  ...
  Stream<CartState> _mapCartProductRemovedToState (CartProductRemove event, CartState state) async* {
    if(state is CartLoaded){
      try{
